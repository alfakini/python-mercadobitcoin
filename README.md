...
mbtc.withdraw_coin_xrp(coin="XRP", quantity="42", address="[address_dest]", tx_fee="[tx_fee_amount]", destination_tag="[tag_dest]", description="Trasfering Money.")
mbtc.withdraw_coin(coin="BTC", quantity="42", address="[address_dest]", tx_fee="[tx_fee_amount]", description="Trasfering Money.")
```
